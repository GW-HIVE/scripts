# Script will reprocess the vcf output of a HIVE Heptagon file to be in the appropriate vcf file format per the
# standard.
    ...
    for line in inFile:
        if line[0] == '#':
            ...
            try:
                ...
                print(str(chromo) + '\t' + str(position) + '\t' + seqid + '\t' + ref + '\t' + alt + '\t' + str(
                    qual) + '\t' + seqfilter + '\t' + info + '\n', file=outFile, end='')
            except:
